                            ...
                            <div className='border-t border-gray-100 py-3 flex flex-col gap-4'>
                                {i.products.map((i) => (
                                    <div key={i?._id} className="flex items-satrt gap-4">
                                        <img src={`https://shopstore-server.onrender.com/uploads/${i?.product?.mainImage}`} alt="Product" className="w-16 h-16 rounded-md object-cover border border-gray-100" />
